...
popupFormProfile.addEventListener('submit', (evt) => {
  const submitButton = evt.target.querySelector('.popup__button-submit');
  const originalButtonText = submitButton.textContent;
  submitButton.textContent = 'Сохраняю...'; 
  console.log("OTPRAVIL..")
  patchprofile(inputName.value,inputJob.value,submitButton,originalButtonText);
...
popupFormTypeAva.addEventListener('submit', (evt) => {
  ...
  const originalButtonText = submitButton.textContent;
  submitButton.textContent = 'Сохраняю...'; 
  patchlogo(popuplinka.value,submitButton,originalButtonText);
...
popupFormPlace.addEventListener('submit', (evt) => {
  ...
  addcardonserver(popupFormTitle.value,popupFormLink.value,submitButton,originalButtonText);
  evt.target.reset();
...
function takeuserdata(){
  fetch('https://nomoreparties.co/v1/frontend-st-cohort-201/users/me ', {
    headers: {authorization: '1c78c69e-0125-4898-8b81-b0d3658cf4a3'},
    method: 'GET'
  })
  .then((res) => {
    return res.json();
...
function patchprofile(name, about, submitButton,originalButtonText) {
  fetch('https://nomoreparties.co/v1/frontend-st-cohort-201/users/me', {
    method: 'PATCH',
    headers: {
      authorization: '1c78c69e-0125-4898-8b81-b0d3658cf4a3 ',
...
function addcardonserver(name,link,submitButton,originalButtonText){
  fetch('https://nomoreparties.co/v1/frontend-st-cohort-201/cards', {
    method: 'POST',
    headers: {
      authorization: '1c78c69e-0125-4898-8b81-b0d3658cf4a3 ',
...
function patchlogo(link,submitButton,originalButtonText) {
...
//
//Токен: 1c78c69e-0125-4898-8b81-b0d3658cf4a3 
